 ...
 */
static char *font = "UbuntuMono Nerd Font:size=11:antialias=true:autohint=false";
static char *font2[] = { "UbuntuMono Nerd Font:size=11:antialias=true:autohint=false" };
